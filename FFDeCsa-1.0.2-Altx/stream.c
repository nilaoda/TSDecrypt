...
DBG for(dbg=0;dbg<4;dbg++){
DBG   fprintf(stderr,"dbg A0[%i]=",dbg);
DBG   dump_mem("",(unsigned char *)&A[aboff+0][dbg],BYPG,BYPG);
DBG   fprintf(stderr,"dbg B0[%i]=",dbg);
DBG   dump_mem("",(unsigned char *)&B[aboff+0][dbg],BYPG,BYPG);
DBG }
...
DBG   dump_mem("",(unsigned char *)&A[aboff-1][dbg],BYPG,BYPG);
DBG }
...
DBG   dump_mem("",(unsigned char *)&B[aboff-1][dbg],BYPG,BYPG);
DBG }
...
DBG   dump_mem("",(unsigned char *)&D[dbg],BYPG,BYPG);
DBG }
...
DBG   dump_mem("",(unsigned char *)&F[dbg],BYPG,BYPG);
DBG }
DBG fprintf(stderr,"r=");
DBG dump_mem("",(unsigned char *)&r,BYPG,BYPG);
DBG for(dbg=0;dbg<4;dbg++){
DBG   fprintf(stderr,"E[%i]=",dbg);
DBG   dump_mem("",(unsigned char *)&E[dbg],BYPG,BYPG);
DBG }
...
DBG   dump_mem("",(unsigned char *)&X[dbg],BYPG,BYPG);
DBG }
DBG for(dbg=0;dbg<4;dbg++){
DBG   fprintf(stderr,"Y[%i]=",dbg);
DBG   dump_mem("",(unsigned char *)&Y[dbg],BYPG,BYPG);
DBG }
DBG for(dbg=0;dbg<4;dbg++){
DBG   fprintf(stderr,"Z[%i]=",dbg);
DBG   dump_mem("",(unsigned char *)&Z[dbg],BYPG,BYPG);
DBG }
DBG fprintf(stderr,"p=");
DBG dump_mem("",(unsigned char *)&p,BYPG,BYPG);
DBG fprintf(stderr,"q=");
DBG dump_mem("",(unsigned char *)&q,BYPG,BYPG);
